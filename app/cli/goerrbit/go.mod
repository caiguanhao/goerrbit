...
require (
	github.com/caiguanhao/goerrbit v1.4.0
	github.com/caiguanhao/goerrbit/plugins/command v0.0.0-20210712111506-8da1269fd851
	github.com/caiguanhao/goerrbit/plugins/lark v0.0.0-20210712111506-8da1269fd851
